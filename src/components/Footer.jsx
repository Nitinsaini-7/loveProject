	...
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<Link  href="#" className="flex justify-center space-x-3 lg:justify-start">
				...
				<span className="self-center text-2xl font-semibold capitalize">propinfratech realtors pvt ltd</span>
			</Link>
		</div>
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			<div className="space-y-3">
				<h3 className="tracking-wide uppercase text-cyan-500 font-bold">Services</h3>
			...
			<div className="space-y-3">
				<h3 className="tracking-wide uppercase text-cyan-500 font-bold">Company</h3>
				<ul className="space-y-1">
					<li>
			...
			<div className="space-y-3">
				<h3 className="uppercase text-cyan-500 font-bold">Contact</h3>
				<ul className="space-y-1">
					<li>
						<Link to={"tel:"}  href="#">+91 XXXXXXXXXX</Link>
					</li>
					<li>
						<Link to={"mailto:"}  href="#">xyz@gmail.com</Link>
					</li>
				</ul>
			</div>
			<div className="space-y-3">
				<div className="uppercase text-cyan-500 font-bold">Social media</div>
