...
const ResidentialProjects = () => {
  ...
  return (
    <div className="sm:mt-10 mt-20">
        <Title heading1={"Residential"} heading2={"Projects"} para={'Explore a diverse range of exquisite properties designed to cater to every lifestyle. Astra Asset Portfolio Management Pvt. Ltd. offers a collection of homes that blend modern comfort with timeless elegance.'} />
